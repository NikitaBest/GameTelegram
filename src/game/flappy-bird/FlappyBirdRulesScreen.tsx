...
interface FlappyBirdRulesScreenProps {
  onStart: () => void;
}

export function FlappyBirdRulesScreen({ onStart }: FlappyBirdRulesScreenProps) {
  return (
    <div 
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-white text-sm md:text-base leading-relaxed flex-1">
              Тапай по экрану, чтобы птица прыгала
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-white text-sm md:text-base leading-relaxed flex-1">
              Пролетай между трубами для получения очков
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 mt-0.5">
              <AlertTriangle className="w-5 h-5 md:w-6 md:h-6 text-white" strokeWidth={2.5} />
            </div>
            <p className="text-white text-sm md:text-base leading-relaxed flex-1">
              Избегай столкновений с трубами и границами!
            </p>
          </div>
        </div>
      </div>
